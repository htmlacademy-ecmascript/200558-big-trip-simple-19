...
//   }
// }
// let url = 'https://19.ecmascript.pages.academy/big-trip-simple';


// fetch(url + '/points', { method: 'get', headers: new Headers({ 'Content-Type': 'application/json' }) }).then((data) => {
//   return data.text();
// }).then((data) => {
//   console.log(data);
// });
